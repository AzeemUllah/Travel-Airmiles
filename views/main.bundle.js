...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__cardspage_cardspage_component__ = __webpack_require__("./src/app/cardspage/cardspage.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__blogpage_blogpage_component__ = __webpack_require__("./src/app/blogpage/blogpage.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__cardspage_cardspage_component__["a" /* CardspageComponent */],
                __WEBPACK_IMPORTED_MODULE_11__blogpage_blogpage_component__["a" /* BlogpageComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__angular_router__["b" /* RouterModule */].forRoot([
                    ...
                    { path: 'cards', component: __WEBPACK_IMPORTED_MODULE_10__cardspage_cardspage_component__["a" /* CardspageComponent */] },
                    { path: 'blog', component: __WEBPACK_IMPORTED_MODULE_11__blogpage_blogpage_component__["a" /* BlogpageComponent */] }
                ]),
            ],
...
var BlogpageComponent = /** @class */ (function () {
    function BlogpageComponent(http, toastr, vcr, router) {
        this.http = http;
        this.toastr = toastr;
        this.router = router;
        this.firstName = '';
    ...
    BlogpageComponent.prototype.ngOnInit = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_4_jquery__('#openLogin').click(function () {
            __WEBPACK_IMPORTED_MODULE_4_jquery__('#signupModalCloseBtn').click();
        });
    };
    BlogpageComponent.prototype.signup = function () {
        var _this = this;
    ...
    BlogpageComponent.prototype.login = function () {
        var _this = this;
        this.regexp = new RegExp(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/);
        if (this.loginEmail.length == 0) {
            ...
            this.http.post("http://thethinkcity.com:3000/api/login", {
                ...
                if (val['status'] == 'Error') {
                    ...
                    __WEBPACK_IMPORTED_MODULE_4_jquery__('#loginModalCloseBtn').click();
                    __WEBPACK_IMPORTED_MODULE_4_jquery__('body').css('padding-right', '0px !important');
                    setTimeout(function () {
    ...
    BlogpageComponent.prototype.showMenu = function () {
        if (__WEBPACK_IMPORTED_MODULE_4_jquery__('#dropdown').css('display') == 'none') {
            __WEBPACK_IMPORTED_MODULE_4_jquery__('#dropdown').css('display', 'block');
        }
        else {
            __WEBPACK_IMPORTED_MODULE_4_jquery__('#dropdown').css('display', 'none');
        }
    };
    BlogpageComponent.prototype.getBase64 = function (file) {
        var _this = this;
    ...
    BlogpageComponent.prototype.uploadFile = function (event) {
    ...
    BlogpageComponent.prototype.logout = function () {
        localStorage.removeItem('id');
        this.toastr.success("Logout Sucessful!", 'Success!');
        setTimeout(function () { window.location.reload(); }, 1000);
    };
    BlogpageComponent.prototype.gotoDashboard = function () {
        this.router.navigate(['dashboard']);
    };
    BlogpageComponent.prototype.gotoHome = function () {
        this.router.navigate(['']);
    };
    BlogpageComponent.prototype.gotoCards = function () {
        this.router.navigate(['cards']);
    };
    BlogpageComponent.prototype.gotoBlog = function () {
        this.router.navigate(['blog']);
    };
    BlogpageComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-blogpage',
            template: __webpack_require__("./src/app/blogpage/blogpage.component.html"),
            styles: [__webpack_require__("./src/app/blogpage/blogpage.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_2_ng2_toastr__["ToastsManager"], __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewContainerRef"], __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */]])
    ], BlogpageComponent);
...
/***/ "./src/app/cardspage/cardspage.component.css":
/***/ (function(module, exports) {

module.exports = "body{\n  background-color: #F6F6F6;\n}\n\n/*NAVBAR*/\n\n.navbar-default{\n  background-color: transparent;\n  border-color: transparent;\n  border: none;\n  font-weight: 100;\n  font-size: 0.8em;\n\n}\n\n.navbar-default .navbar-nav .l{\n\n  border-right: 1px #6c757d solid;\n  height: 40px;\n}\n\n.navbar-default .navbar-nav li a {\n  color: #FFFFFF;\n}\n\n.navbar-nav{\n  color: #FFFFFF;\n  padding-top: 20px;\n}\n\n.s p{\n  line-height: 0;\n  font-weight: 100;\n  font-size: 0.8em;\n}\n\n.s h4{\n  font-weight: 100;\n  font-size: 0.9em;\n}\n\n/*NAVBAR-ENDS*/\n\n/*HOME*/\n\n#home{\n  background: url('header-bg.8a5de50a3bfe616559b0.png');\n  background-repeat: no-repeat;\n  background-size: cover;\n  width: 100%;\n}\n\n#home h2{\n  line-height: 1.3;\n  padding-top: 200px;\n  padding-bottom: 15px;\n  color: white;\n  font-weight: 200;\n  font-size: 2.9em;\n}\n\n#home p{\n  line-height: 2;\n  color: white;\n  margin-bottom: 35px;\n  font-size: 1.3em;\n  font-weight: 400;\n}\n\n#home .p{\n  padding-bottom: 60px;\n}\n\n#home .r{\n  padding-bottom: 150px;\n  text-align: center;\n}\n\n#home .btn1{\n  /*margin-top: 20px;*/\n  /*margin-bottom: 100px;*/\n  padding-right: 40px;\n  padding-left: 40px;\n  background-color: #014FA2;\n  border-radius: 20px;\n  border: none;\n}\n\n#home .btn2{\n  background-color: transparent;\n  border-color: #FFFFFF;\n  border-radius: 20px;\n  padding-right: 40px;\n  padding-left: 40px;\n}\n\n#home .navigation .menu a{\n  color: #FFFFFF;\n}\n\n/*HOME-ENDS*/\n\n/*FLIGHT*/\n\n#flight .container{\n  margin-top: -7px;\n  position: relative;\n}\n\n#flight .i{\n  text-align: center;\n}\n\n#flight p{\n  text-align: center;\n}\n\n#flight .f{\n  background-color: #FFFFFF;\n  text-align: center;\n  z-index: 2;\n}\n\n#flight .r{\n  margin-top: 30px\n}\n\n#flight .i{\n  margin-top: 50px;\n}\n\n#flight p{\n  color: #B7B7B7;\n}\n\n#flight .r1{\n  margin-top: 60px;\n  margin-left: -30px;\n}\n\n#flight .r2{\n  margin-top: 175px;\n  margin-left: 25px;\n}\n\n#flight .r3{\n  position: relative;\n  margin-top: 25px;\n  margin-right: -16px;\n  float: right;\n  z-index: -1;\n}\n\n/*FLIGHT-ENDS*/\n\n/*FEATURES*/\n\n#features .container{\n  margin-top: -38px;\n  background-color:#014FA2;\n  color :#FFFFFF;\n}\n\n#features h1{\n  font-weight: 200;\n  font-size: large;\n}\n\n#features h4{\n  font-weight: 300;\n  font-size: inherit;\n}\n\n#features p{\n  color: #CFD2D5;\n  font-size: small;\n  font-weight: 200;\n}\n\n#features .top{\n  margin-top: 30px;\n  text-align: center;\n}\n\n#features .btn {\n  color: #ffffff;\n  border-color: #FFFFFF;\n  background-color: transparent;\n  border-radius: 20px;\n  padding-top: 8px;\n  padding-bottom: 8px;\n  padding-right: 50px;\n  padding-left: 50px;\n}\n\n#features .middle1{\n  margin-top: 50px;\n  /*text-align: center;*/\n}\n\n#features .middle2{\n  margin-top: 50px;\n}\n\n#features .end{\n  text-align: center;\n  margin-top: 50px;\n  margin-bottom: 60px;\n}\n\n/*FEATURES-ENDS*/\n\n/*CARRIERS*/\n\n#carriers .container{\n  background-color: #FFFFFF;\n}\n\n#carriers h3{\n  font-weight: 200;\n}\n\n#carriers p{\n  color: #D8D8D8;\n  font-size: 1em;\n  font-weight: 200;\n}\n\n#carriers .top{\n  text-align: center;\n  margin-top: 40px;\n}\n\n#carriers .i{\n  margin-top: 25px;\n}\n\n#carriers .middle1{\n  margin-top: 70px;\n  text-align: -webkit-center;\n}\n\n#carriers .middle2{\n  margin-top: 70px;\n  text-align: -webkit-center;\n}\n\n#carriers .middle3{\n  text-align: -webkit-center;\n  margin-top: 70px;\n  margin-bottom: 65px;\n}\n\n/*CARRIERS-ENDS*/\n\n/*NEWSLETTER*/\n\n#newsletter .container{\n  background-color:#014FA2;\n  color: #FFFFFF;\n}\n\n#newsletter{\n  text-align: center;\n}\n\n#newsletter h1{\n  font-size: 1.6em;\n  font-weight: 200;\n  margin-top: 45px;\n  margin-bottom: 35px;\n}\n\n#newsletter .l{\n  margin-bottom: 45px;\n}\n\n#newsletter .fa{\n  float: right;\n  position: absolute;\n  margin-top: 10px;\n  margin-left: -26px;\n  color: #014FA2;\n}\n\n#newsletter input{\n  padding-right: 240px;\n  padding-left: 16px;\n  padding-top: 7px;\n  padding-bottom: 7px;\n  border-radius: 21px;\n  border: none;\n  color: #BCBCBC;\n  font-size: 1.1em;\n  font-weight: 200;\n}\n\n/*NEWSLETTERENDS*/\n\n/*FAQ'S*/\n\n#faq .container{\n  background-color: #FFFFFF;\n}\n\n#faq .top{\n  text-align: center;\n  margin-top: 40px;\n  margin-bottom: 20px;\n}\n\n#faq h2{\n  font-size: 1.8em;\n  font-weight: 200;\n\n}\n\n#faq .top p{\n  color : #858585;\n  font-size: 0.9em;\n  font-weight: 200;\n}\n\n#faq p{\n  color : #B1B7BD;\n  font-size: 0.9em;\n  font-weight: 200;\n  letter-spacing: 1px;\n  line-height: 25px;\n}\n\n#faq .grp{\n  margin-left: 5%;\n  margin-right: 3%;\n}\n\n#faq h3{\n  font-size: 1.2em;\n  font-weight: 200;\n  line-height: 40px;\n\n}\n\n#faq .last{\n  margin-bottom: 70px;\n}\n\n/*FAQ'S-ENDS*/\n\n/*FOOTER*/\n\n#footer .container{\n  background-color: #0F346C;\n}\n\n#footer .one{\n  margin-top: 50px;\n  margin-bottom: 50px;\n}\n\n#footer img{\n  margin-left: 55px;\n}\n\n#footer h5{\n  margin-top: 14px;\n  margin-left: 22px;\n  font-size: 1.1em;\n  font-weight: 200;\n  color: #FFFFFF;\n}\n\n#footer .fa{\n  color: #FFFFFF;\n}\n\n/*FOOTER-ENDS*/\n\n/*MEDIA*/\n\n@media (max-width:768px) {\n\n  .logo img {\n    margin-left: 10px;\n  }\n  #navbar{\n    display: block;\n  }\n  .logo1{\n    display: none;\n  }\n  .navbar-toggle {\n    margin-top:20px;\n    margin-right:15px;\n  }\n  .navbar-default .navbar-nav .l{\n    display: none;\n  }\n  #home .btn1{\n    padding-right: 25px;\n    padding-left: 25px;\n  }\n  #home .btn2{\n    padding-right: 20px;\n    padding-left: 20px;\n  }\n  #flight .r1{\n    display: none;\n  }\n  #flight .r2{\n    display: none;\n  }\n  #flight .r3{\n    margin-top: 30px;\n    float: initial;\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n  }\n  #flight .i{\n    margin-left: -3px;\n  }\n  #features .middle1{\n    text-align: center;\n  }\n  #features .middle2{\n    text-align: center;\n  }\n  #features .i{\n    margin-top: 25px;\n  }\n  #carriers .i{\n    margin-left: -3px;\n  }\n  #newsletter input{\n    padding-right:145px;\n    padding-left: 16px;\n    padding-top: 7px;\n    padding-bottom: 7px;\n    border-radius: 21px;\n    border: none;\n    color: #BCBCBC;\n    font-size: 1.1em;\n    font-weight: 200;\n  }\n  #faq .grp {\n    text-align: center;\n    margin-left: 0%;\n    margin-right: 0%;\n  }\n  #footer .txt{\n    text-align: center;\n  }\n\n  #footer .one{\n    text-align: center;\n  }\n\n  .footerSocialMediaIcons{\n    margin-left: 30%;\n  }\n}\n\n@media (max-width:992px){\n\n  #flight .r2{\n    margin-top: 160px;\n    margin-left: -15px;\n  }\n}\n\n@media (max-width:375px){\n  #footer img {\n    margin-left: 15px;\n  }\n}\n\n.pricingText{\n  text-align: center;\n}\n\n.promo {\n  width: 250px;\n  background: #FFFFFF;\n  color: #f9f9f9;\n  float: left;\n}\n\n.deal {\n  padding: 10px 0 0 0;\n}\n\n.deal span {\n  display: block;\n  text-align: center;\n}\n\n.deal span:first-of-type {\n  font-size: 23px;\n}\n\n.deal span:last-of-type {\n  font-size: 23px;\n}\n\n.promo .price {\n  display: block;\n  width: 100%;\n  background: #F6F6F6;\n  margin: 15px 0 10px 0;\n  text-align: center;\n  font-size: 43px;\n  padding: 17px 0 17px 0;\n}\n\nul {\n  display: block;\n  margin: 20px 0 10px 0;\n  padding: 0;\n  list-style-type: none;\n  text-align: left;\n  color: #203B4E;\n}\n\nli {\n  display: block;\n  margin: 10px 0 0 0;\n}\n\n.scale {\n  /*transform: scale(1.2);*/\n  -webkit-box-shadow: 0 0 4px 1px #d4dbe2;\n          box-shadow: 0 0 4px 1px #d4dbe2;\n}\n\n.scale .price {\n  color: #203B4E;\n}\n\n.pricingSubtext{\n  color: #969696;\n}\n\n.price p{\n  font-size: 19px;\n  color: #8E8D8D;\n}\n\n.deal span{\n  color: #203B4E;\n}\n\n.features {\n  margin-right: 5%;\n  margin-left: 5%;\n  line-height: 2em;\n}\n\n.features li img{\n  margin-right: 3%;\n}\n\n#pricing .btn2 {\n  background-color: transparent;\n  border-color: #014FA2;\n  color: #014FA2;\n  border-radius: 20px;\n  padding-right: 40px;\n  padding-left: 40px;\n  margin-bottom: 10%;\n  padding-top: 3%;\n  margin-top: 10%;\n  padding-bottom: 3%;\n}\n\n.promo.scale{\n  text-align: center;\n  width: 100%;\n}\n\n#pricing .btn3 {\n  background-color: transparent;\n  border-color: #ffffff;\n  color: #ffffff;\n  background-color: #014FA2;\n  border-radius: 20px;\n  padding-right: 40px;\n  padding-left: 40px;\n  margin-bottom: 10%;\n  padding-top: 3%;\n  margin-top: 10%;\n  padding-bottom: 3%;\n}\n\n.pricingCardHolder{\n  margin-top: 3%;\n  margin-left: 8%;\n  margin-right: 8%;\n}\n\n.pricingHeadingHolder{\n  margin-top: 4%;\n}\n\n.pricingContainer{\n  background: white;\n  padding-bottom: 5%;\n}\n\n@media (max-width:400px){\n  .pricingCardHolder > div{\n    margin-bottom: 10%;\n  }\n\n  .features{\n    line-height: 1.5em;\n  }\n\n  #pricing .btn2{\n    margin-bottom: 7%;\n    margin-top: 5%;\n  }\n\n  #pricing .btn3{\n    margin-bottom: 7%;\n    margin-top: 5%;\n  }\n\n  .pricingCardHolder {\n    margin-left: 1%;\n    margin-right: 1%;\n    margin-top: 10%;\n  }\n\n  .pricingSubtext{\n    margin-right: 1%;\n    margin-left: 1%;\n  }\n}\n\n@media (max-width:992px){\n  .pricingCardHolder{\n    margin-left: 1%;\n    margin-right: 1%;\n  }\n\n  .features{\n    line-height: 1.5em;\n  }\n\n  .reviewContent{\n    margin-left: 5%;\n    margin-right: 5%;\n  }\n\n  .reviewPeople{\n    text-align: center;\n  }\n}\n\n.usersFeedbackContainer{\n  background-color: #014FA2;\n}\n\n.usersFeedbackText{\n  text-align: center;\n}\n\n.usersFeedbackText > h3{\n  color: white;\n}\n\n.usersFeedbackText > p{\n  color: #BCBCBC;\n}\n\n.reviews{\n  color: white;\n  font-size: 20px;\n  text-align: center;\n}\n\n.usersFeedbackHeading{\n  margin-top: 5%;\n  margin-bottom: 6%;\n}\n\n.usersFeedbackQuotes{\n  margin-bottom: 2%;\n}\n\n.reviewContent{\n  line-height: 2.4em;\n  letter-spacing: 0.1em;\n  font-weight: 100;\n}\n\n.reviewPeople{\n  margin-top: 6%;\n}\n\n.reviewName{\n  line-height: 0.7em;\n  margin-top: 5%;\n}\n\n.reviewName p:nth-child(1){\n  font-size: 16px;\n  color: white;\n}\n\n.reviewName p:nth-child(2){\n  font-size: 14px;\n  color: white;\n}\n\n.faded{\n  opacity: 0.5;\n}\n\n.notFaded{\n  opacity: 1;\n}\n\n.reviewPeople img{\n  width: 57px;\n}\n\n@media (max-width:670px){\n  .reviewName{\n    line-height: 1em;\n  }\n}\n\n@media (max-width:670px){\n  .reviewPeople div:nth-child(3){\n    padding: 0;\n  }\n}\n\n#pricing button:hover {\n  background-color: transparent;\n  border-color: #ffffff;\n  color: #ffffff;\n  background-color: #014FA2;\n  border-radius: 20px;\n  padding-right: 40px;\n  padding-left: 40px;\n  margin-bottom: 10%;\n  padding-top: 3%;\n  margin-top: 10%;\n  padding-bottom: 3%;\n}\n\n.hamburger {\n  height: 30px;\n  margin: 26px;\n  display: -ms-grid;\n  display: grid;\n  -ms-grid-rows: (1fr)[3];\n      grid-template-rows: repeat(3, 1fr);\n  justify-items: center;\n  z-index: 120;\n}\n\n.hamburger div {\n  background-color: rgb(255, 255, 255);\n  position: relative;\n  width: 40px;\n  height: 2px;\n  margin-top: 7px;\n  -webkit-transition: all 0.2s ease-in-out;\n  transition: all 0.2s ease-in-out;\n}\n\n#toggle {\n  display: none;\n}\n\n#toggle:checked + .hamburger .top {\n  -webkit-transform: rotate(-45deg);\n  transform: rotate(-45deg);\n  margin-top: 22.5px;\n}\n\n#toggle:checked + .hamburger .meat {\n  -webkit-transform: rotate(45deg);\n  transform: rotate(45deg);\n  margin-top: -5px;\n}\n\n#toggle:checked + .hamburger .bottom {\n  -webkit-transform: scale(0);\n  transform: scale(0);\n}\n\n#toggle:checked ~ .menu {\n  height: 480px;\n}\n\n/* Menu */\n\n.menu {\n  width: 100%;\n  background-color: #067df4;\n  /*opacity: 0.9;*/\n  margin: 0;\n  display: -ms-grid;\n  display: grid;\n  -ms-grid-rows: 1fr (0.5fr)[4];\n      grid-template-rows: 1fr repeat(4, 0.5fr);\n  grid-row-gap: 25px;\n  padding: 0;\n  list-style: none;\n  clear: both;\n  width: auto;\n  text-align: center;\n  height: 0px;\n  overflow: hidden;\n  -webkit-transition: height 0.4s ease;\n  transition: height 0.4s ease;\n  z-index: 120;\n  -webkit-transition: all 0.3s ease;\n  transition: all 0.3s ease;\n}\n\na:focus, a:hover {\n  text-decoration: none !important;\n}\n\n.menu a{\n  color: #FFFFFF;\n}\n\n.menu a:first-child {\n  margin-top: 58px;\n}\n\n.link {\n  width: 100%;\n  margin: 0;\n  /*padding: 10px 0;*/\n  font: 700 20px \"Oswald\", sans-serif;\n}\n\n/*.link:hover {*/\n\n/*color:#FFFFFF;*/\n\n/*background-color: transparent;*/\n\n/*color: rgb(61, 61, 61);*/\n\n/*-webkit-transition: all 0.3s ease;*/\n\n/*transition: all 0.3s ease;*/\n\n/*}*/\n\n@media (max-width:767px){\n\n  #navbar1{\n    display: none;\n  }\n\n  #navbar{\n    display: block;\n  }\n}\n\na{\n  cursor: pointer;\n}\n\n@media (max-width:400px){\n  .hamburger{\n    margin-right: 35px;\n    margin-top: 20px;\n  }\n  #flight .container{\n    margin-top: -9px;\n    position: relative;\n  }\n}\n\n.navigation{\n  display: none;\n}\n\n/*CREDIT CARD PAGE CSS*/\n\n.heading-credit-card{\n  margin-top: 30px;\n  text-align: center;\n  color: #6c757d;\n}\n\n.card-heading{\n  text-align: center;\n  color: #5280C6;\n  margin-bottom: 30px;\n}\n\n.price-card-head{\n  font-size: 1.7em;\n  text-align: center;\n}\n\n.price-card-para{\n  text-align: center;\n  padding-bottom: 30px;\n}\n\n.line{\n  margin-top: 15px;\n  background-color: chocolate;\n  width: 32%;\n  height: 4px;\n  text-align: center;\n  margin-left: auto;\n  margin-right: auto;\n  margin-bottom: 17px;\n}\n\n.shadow{\n  -webkit-box-shadow: 0 0 20px rgba(0,0,0,.06);\n          box-shadow: 0 0 20px rgba(0,0,0,.06);\n  padding-right: 0;\n  padding-left: 0;\n}\n\n.img-div{\n  margin-bottom: 10px;\n  z-index: 0;\n  margin-top: -25px;\n  /*margin-top: 30px;*/\n}\n\n.main{\n  border-radius: 0vh 0vh 200vh 220vh / 0vh 0vh 20vh 20vh;\n  background-color: #f6f6f6;\n  margin-bottom: 0px;\n  z-index: 1;\n  position: relative;\n}\n\n.card-row2{\n  margin-top: 50px;\n  margin-bottom: 30px;\n}\n\n#footer{\n  background-color: #0F346C;\n}\n\n@media (min-width:768px) and (max-width:1199px) {\n  .price-card-head {\n    font-size: 1.5em;\n    text-align: center;\n  }\n}\n\n@media (max-width: 768px) {\n  .shadow {\n    margin-bottom: 31px;\n  }\n\n  .img-card{\n    width: 100%;\n  }\n\n  .price-card-head {\n    font-size: 1.5em;\n    text-align: center;\n  }\n  .heading-credit-card {\n    font-size: 1.6em;\n    margin-top: 30px;\n    text-align: center;\n    color: #6c757d;\n  }\n\n  .card-heading {\n    font-size: 1.5em;\n    text-align: center;\n    color: #5280C6;\n    margin-bottom: 30px;\n  }\n}\n\n/*CREDIT CARD PAGE CSS END*/\n\n@media (max-width:767px) {\n  .pricingCardHolder > div {\n    margin-bottom: 10%;\n  }\n}\n\n@media (max-width:339px){\n  #flight .flightdetails {\n    width: 80.33%\n  }\n  #carriers .carrierdetails{\n    witdh:80.33%;\n  }\n}\n\n@media (min-width:1528px){\n  #flight .container{\n    margin-top: 0px;\n    position: relative;\n  }\n}\n\n@media (min-width:1518px) and (max-width:1523px) {\n  #flight .container{\n    margin-top: -3px;\n    position: relative;\n  }\n}\n\n@media (min-width:1523px) and (max-width:1525px) {\n  #flight .container{\n    margin-top: -3px;\n    position: relative;\n  }\n}\n\n@media (min-width:1526px) and (max-width:1528px) {\n  #flight .container{\n    margin-top: -1px;\n    position: relative;\n  }\n}\n\n@media (min-width:768px) and (max-width:992px) {\n  #footer .txt{\n    margin-left: 30%;\n  }\n  #footer .img{\n    margin-left: 35%;\n    padding-bottom: 10px;\n  }\n  .footerSocialMediaIcons{\n    padding-top: 10px;\n    margin-left: 36%;\n  }\n}\n\n@media (min-width: 768px) {\n  .hamburger{\n    display: none;\n  }\n  .menu a{\n    padding-bottom: 100px;\n  }\n\n}\n\n/*@media (max-width: 768px) {*/\n\n/*#flight .container{*/\n\n/*margin-top: -8.5px;*/\n\n/*z-index: -2;*/\n\n/*position: relative;*/\n\n/*}*/\n\n/*}*/\n\n@media (max-width:400px) {\n\n  #sideBarToggle {\n    display: block !important;\n  }\n\n}\n\n.modal-backdrop{\n  z-index: 0 !important;\n}\n\n/*******************************\n* MODAL AS LEFT/RIGHT SIDEBAR\n* Add \"left\" or \"right\" in modal parent div, after class=\"modal\".\n* Get free snippets on bootpen.com\n*******************************/\n\n.modal.left .modal-dialog,\n.modal.right .modal-dialog {\n  position: fixed;\n  margin: auto;\n  width: 320px;\n  height: 100%;\n  -webkit-transform: translate3d(0%, 0, 0);\n  transform: translate3d(0%, 0, 0);\n}\n\n.modal.left .modal-content,\n.modal.right .modal-content {\n  height: 100%;\n  overflow-y: auto;\n}\n\n.modal.left .modal-body,\n.modal.right .modal-body {\n  padding: 15px 15px 80px;\n}\n\n/*Left*/\n\n.modal.left.fade .modal-dialog{\n  left: -320px;\n  -webkit-transition: opacity 0.3s linear, left 0.3s ease-out;\n  transition: opacity 0.3s linear, left 0.3s ease-out;\n}\n\n.modal.left.fade.in .modal-dialog{\n  left: 0;\n}\n\n/*Right*/\n\n.modal.right.fade .modal-dialog {\n  right: -320px;\n  -webkit-transition: opacity 0.3s linear, right 0.3s ease-out;\n  transition: opacity 0.3s linear, right 0.3s ease-out;\n}\n\n.modal.right.fade.in .modal-dialog {\n  right: 0;\n}\n\n/* ----- MODAL STYLE ----- */\n\n.modal-content {\n  border-radius: 0;\n  border: none;\n}\n\n.modal-header {\n  border-bottom-color: #EEEEEE;\n  background-color: #FAFAFA;\n}\n\n/* ----- v CAN BE DELETED v ----- */\n\n.demo {\n  padding-top: 60px;\n  padding-bottom: 110px;\n}\n\n.btn-demo {\n  margin: 15px;\n  padding: 10px 15px;\n  border-radius: 0;\n  font-size: 16px;\n  background-color: #FFFFFF;\n}\n\n.btn-demo:focus {\n  outline: 0;\n}\n\n.demo-footer {\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  padding: 15px;\n  background-color: #212121;\n  text-align: center;\n}\n\n.demo-footer > a {\n  text-decoration: none;\n  font-weight: bold;\n  font-size: 16px;\n  color: #fff;\n}\n\n.sideBarCloseBtn:focus {\n  outline: none !important;\n}\n\n.selectError{\n  border-bottom: 1px solid red;\n}\n\nbody{\n  background-color: #F6F6F6;\n}\n\n/*NAVBAR*/\n\n.navbar-default{\n  background-color: transparent;\n  border-color: transparent;\n  border: none;\n  font-weight: 100;\n  font-size: 0.8em;\n\n}\n\n.navbar-default .navbar-nav .l{\n\n  border-right: 1px #6c757d solid;\n  height: 40px;\n}\n\n.navbar-default .navbar-nav li a {\n  color: #FFFFFF;\n}\n\n.navbar-nav{\n  color: #FFFFFF;\n  padding-top: 20px;\n}\n\n.s p{\n  line-height: 0;\n  font-weight: 100;\n  font-size: 0.8em;\n}\n\n.s h4{\n  font-weight: 100;\n  font-size: 0.9em;\n}\n\n/*NAVBAR-ENDS*/\n\n/*HOME*/\n\n#home{\n  background: url('header-bg.8a5de50a3bfe616559b0.png');\n  background-repeat: no-repeat;\n  background-size: cover;\n  width: 100%;\n}\n\n#home h2{\n  line-height: 1.3;\n  padding-top: 200px;\n  padding-bottom: 15px;\n  color: white;\n  font-weight: 200;\n  font-size: 2.9em;\n}\n\n#home p{\n  line-height: 2;\n  color: white;\n  margin-bottom: 35px;\n  font-size: 1.3em;\n  font-weight: 400;\n}\n\n#home .p{\n  padding-bottom: 60px;\n}\n\n#home .r{\n  padding-bottom: 150px;\n  text-align: center;\n}\n\n#home .btn1{\n  /*margin-top: 20px;*/\n  /*margin-bottom: 100px;*/\n  padding-right: 40px;\n  padding-left: 40px;\n  background-color: #014FA2;\n  border-radius: 20px;\n  border: none;\n}\n\n#home .btn2{\n  background-color: transparent;\n  border-color: #FFFFFF;\n  border-radius: 20px;\n  padding-right: 40px;\n  padding-left: 40px;\n}\n\n#home .navigation .menu a{\n  color: #FFFFFF;\n}\n\n/*HOME-ENDS*/\n\n/*FLIGHT*/\n\n#flight .container{\n  margin-top: -7px;\n  position: relative;\n}\n\n#flight .i{\n  text-align: center;\n}\n\n#flight p{\n  text-align: center;\n}\n\n#flight .f{\n  background-color: #FFFFFF;\n  text-align: center;\n  z-index: 2;\n}\n\n#flight .r{\n  margin-top: 30px\n}\n\n#flight .i{\n  margin-top: 50px;\n}\n\n#flight p{\n  color: #B7B7B7;\n}\n\n#flight .r1{\n  margin-top: 60px;\n  margin-left: -30px;\n}\n\n#flight .r2{\n  margin-top: 175px;\n  margin-left: 25px;\n}\n\n#flight .r3{\n  position: relative;\n  margin-top: 25px;\n  margin-right: -16px;\n  float: right;\n  z-index: -1;\n}\n\n/*FLIGHT-ENDS*/\n\n/*FEATURES*/\n\n#features .container{\n  margin-top: -38px;\n  background-color:#014FA2;\n  color :#FFFFFF;\n}\n\n#features h1{\n  font-weight: 200;\n  font-size: large;\n}\n\n#features h4{\n  font-weight: 300;\n  font-size: inherit;\n}\n\n#features p{\n  color: #CFD2D5;\n  font-size: small;\n  font-weight: 200;\n}\n\n#features .top{\n  margin-top: 30px;\n  text-align: center;\n}\n\n#features .btn {\n  color: #ffffff;\n  border-color: #FFFFFF;\n  background-color: transparent;\n  border-radius: 20px;\n  padding-top: 8px;\n  padding-bottom: 8px;\n  padding-right: 50px;\n  padding-left: 50px;\n}\n\n#features .middle1{\n  margin-top: 50px;\n  /*text-align: center;*/\n}\n\n#features .middle2{\n  margin-top: 50px;\n}\n\n#features .end{\n  text-align: center;\n  margin-top: 50px;\n  margin-bottom: 60px;\n}\n\n/*FEATURES-ENDS*/\n\n/*CARRIERS*/\n\n#carriers .container{\n  background-color: #FFFFFF;\n}\n\n#carriers h3{\n  font-weight: 200;\n}\n\n#carriers p{\n  color: #D8D8D8;\n  font-size: 1em;\n  font-weight: 200;\n}\n\n#carriers .top{\n  text-align: center;\n  margin-top: 40px;\n}\n\n#carriers .i{\n  margin-top: 25px;\n}\n\n#carriers .middle1{\n  margin-top: 70px;\n  text-align: -webkit-center;\n}\n\n#carriers .middle2{\n  margin-top: 70px;\n  text-align: -webkit-center;\n}\n\n#carriers .middle3{\n  text-align: -webkit-center;\n  margin-top: 70px;\n  margin-bottom: 65px;\n}\n\n/*CARRIERS-ENDS*/\n\n/*NEWSLETTER*/\n\n#newsletter .container{\n  background-color:#014FA2;\n  color: #FFFFFF;\n}\n\n#newsletter{\n  text-align: center;\n}\n\n#newsletter h1{\n  font-size: 1.6em;\n  font-weight: 200;\n  margin-top: 45px;\n  margin-bottom: 35px;\n}\n\n#newsletter .l{\n  margin-bottom: 45px;\n}\n\n#newsletter .fa{\n  float: right;\n  position: absolute;\n  margin-top: 10px;\n  margin-left: -26px;\n  color: #014FA2;\n}\n\n#newsletter input{\n  padding-right: 240px;\n  padding-left: 16px;\n  padding-top: 7px;\n  padding-bottom: 7px;\n  border-radius: 21px;\n  border: none;\n  color: #BCBCBC;\n  font-size: 1.1em;\n  font-weight: 200;\n}\n\n/*NEWSLETTERENDS*/\n\n/*FAQ'S*/\n\n#faq .container{\n  background-color: #FFFFFF;\n}\n\n#faq .top{\n  text-align: center;\n  margin-top: 40px;\n  margin-bottom: 20px;\n}\n\n#faq h2{\n  font-size: 1.8em;\n  font-weight: 200;\n\n}\n\n#faq .top p{\n  color : #858585;\n  font-size: 0.9em;\n  font-weight: 200;\n}\n\n#faq p{\n  color : #B1B7BD;\n  font-size: 0.9em;\n  font-weight: 200;\n  letter-spacing: 1px;\n  line-height: 25px;\n}\n\n#faq .grp{\n  margin-left: 5%;\n  margin-right: 3%;\n}\n\n#faq h3{\n  font-size: 1.2em;\n  font-weight: 200;\n  line-height: 40px;\n\n}\n\n#faq .last{\n  margin-bottom: 70px;\n}\n\n/*FAQ'S-ENDS*/\n\n/*FOOTER*/\n\n#footer .container{\n  background-color: #0F346C;\n}\n\n#footer .one{\n  margin-top: 50px;\n  margin-bottom: 50px;\n}\n\n#footer img{\n  margin-left: 55px;\n}\n\n#footer h5{\n  margin-top: 14px;\n  margin-left: 22px;\n  font-size: 1.1em;\n  font-weight: 200;\n  color: #FFFFFF;\n}\n\n#footer .fa{\n  color: #FFFFFF;\n}\n\n/*FOOTER-ENDS*/\n\n/*MEDIA*/\n\n@media (max-width:768px) {\n\n  .logo img {\n    margin-left: 10px;\n  }\n  #navbar{\n    display: block;\n  }\n  .logo1{\n    display: none;\n  }\n  .navbar-toggle {\n    margin-top:20px;\n    margin-right:15px;\n  }\n  .navbar-default .navbar-nav .l{\n    display: none;\n  }\n  #home .btn1{\n    padding-right: 25px;\n    padding-left: 25px;\n  }\n  #home .btn2{\n    padding-right: 20px;\n    padding-left: 20px;\n  }\n  #flight .r1{\n    display: none;\n  }\n  #flight .r2{\n    display: none;\n  }\n  #flight .r3{\n    margin-top: 30px;\n    float: initial;\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n  }\n  #flight .i{\n    margin-left: -3px;\n  }\n  #features .middle1{\n    text-align: center;\n  }\n  #features .middle2{\n    text-align: center;\n  }\n  #features .i{\n    margin-top: 25px;\n  }\n  #carriers .i{\n    margin-left: -3px;\n  }\n  #newsletter input{\n    padding-right:145px;\n    padding-left: 16px;\n    padding-top: 7px;\n    padding-bottom: 7px;\n    border-radius: 21px;\n    border: none;\n    color: #BCBCBC;\n    font-size: 1.1em;\n    font-weight: 200;\n  }\n  #faq .grp {\n    text-align: center;\n    margin-left: 0%;\n    margin-right: 0%;\n  }\n  #footer .txt{\n    text-align: center;\n  }\n\n  #footer .one{\n    text-align: center;\n  }\n\n  .footerSocialMediaIcons{\n    margin-left: 30%;\n  }\n}\n\n@media (max-width:992px){\n\n  #flight .r2{\n    margin-top: 160px;\n    margin-left: -15px;\n  }\n}\n\n@media (max-width:375px){\n  #footer img {\n    margin-left: 15px;\n  }\n}\n\n.pricingText{\n  text-align: center;\n}\n\n.promo {\n  width: 250px;\n  background: #FFFFFF;\n  color: #f9f9f9;\n  float: left;\n}\n\n.deal {\n  padding: 10px 0 0 0;\n}\n\n.deal span {\n  display: block;\n  text-align: center;\n}\n\n.deal span:first-of-type {\n  font-size: 23px;\n}\n\n.deal span:last-of-type {\n  font-size: 23px;\n}\n\n.promo .price {\n  display: block;\n  width: 100%;\n  background: #F6F6F6;\n  margin: 15px 0 10px 0;\n  text-align: center;\n  font-size: 43px;\n  padding: 17px 0 17px 0;\n}\n\nul {\n  display: block;\n  margin: 20px 0 10px 0;\n  padding: 0;\n  list-style-type: none;\n  text-align: left;\n  color: #203B4E;\n}\n\nli {\n  display: block;\n  margin: 10px 0 0 0;\n}\n\n.scale {\n  /*transform: scale(1.2);*/\n  -webkit-box-shadow: 0 0 4px 1px #d4dbe2;\n          box-shadow: 0 0 4px 1px #d4dbe2;\n}\n\n.scale .price {\n  color: #203B4E;\n}\n\n.pricingSubtext{\n  color: #969696;\n}\n\n.price p{\n  font-size: 19px;\n  color: #8E8D8D;\n}\n\n.deal span{\n  color: #203B4E;\n}\n\n.features {\n  margin-right: 5%;\n  margin-left: 5%;\n  line-height: 2em;\n}\n\n.features li img{\n  margin-right: 3%;\n}\n\n#pricing .btn2 {\n  background-color: transparent;\n  border-color: #014FA2;\n  color: #014FA2;\n  border-radius: 20px;\n  padding-right: 40px;\n  padding-left: 40px;\n  margin-bottom: 10%;\n  padding-top: 3%;\n  margin-top: 10%;\n  padding-bottom: 3%;\n}\n\n.promo.scale{\n  text-align: center;\n  width: 100%;\n}\n\n#pricing .btn3 {\n  background-color: transparent;\n  border-color: #ffffff;\n  color: #ffffff;\n  background-color: #014FA2;\n  border-radius: 20px;\n  padding-right: 40px;\n  padding-left: 40px;\n  margin-bottom: 10%;\n  padding-top: 3%;\n  margin-top: 10%;\n  padding-bottom: 3%;\n}\n\n.pricingCardHolder{\n  margin-top: 3%;\n  margin-left: 8%;\n  margin-right: 8%;\n}\n\n.pricingHeadingHolder{\n  margin-top: 4%;\n}\n\n.pricingContainer{\n  background: white;\n  padding-bottom: 5%;\n}\n\n@media (max-width:400px){\n  #sideBarToggle{\n    display: block !important;\n  }\n\n\n  .pricingCardHolder > div{\n    margin-bottom: 10%;\n  }\n\n  .features{\n    line-height: 1.5em;\n  }\n\n  #pricing .btn2{\n    margin-bottom: 7%;\n    margin-top: 5%;\n  }\n\n  #pricing .btn3{\n    margin-bottom: 7%;\n    margin-top: 5%;\n  }\n\n  .pricingCardHolder {\n    margin-left: 1%;\n    margin-right: 1%;\n    margin-top: 10%;\n  }\n\n  .pricingSubtext{\n    margin-right: 1%;\n    margin-left: 1%;\n  }\n\n  .signupModalDialog{\n    width: 80% !important;\n    margin-right: 10%;\n    margin-left: 10%;\n  }\n\n  .signUp-left-div{\n    display: none;\n  }\n\n  .login-para{\n    margin-left: 0px !important;\n  }\n\n  .signinModalDialog{\n    width: 80% !important;\n    margin-left: 10%;\n    margin-right: 10%;\n  }\n\n}\n\n@media (max-width:992px){\n  .pricingCardHolder{\n    margin-left: 1%;\n    margin-right: 1%;\n  }\n\n  .features{\n    line-height: 1.5em;\n  }\n\n  .reviewContent{\n    margin-left: 5%;\n    margin-right: 5%;\n  }\n\n  .reviewPeople{\n    text-align: center;\n  }\n}\n\n.usersFeedbackContainer{\n  background-color: #014FA2;\n}\n\n.usersFeedbackText{\n  text-align: center;\n}\n\n.usersFeedbackText > h3{\n  color: white;\n}\n\n.usersFeedbackText > p{\n  color: #BCBCBC;\n}\n\n.reviews{\n  color: white;\n  font-size: 20px;\n  text-align: center;\n}\n\n.usersFeedbackHeading{\n  margin-top: 5%;\n  margin-bottom: 6%;\n}\n\n.usersFeedbackQuotes{\n  margin-bottom: 2%;\n}\n\n.reviewContent{\n  line-height: 2.4em;\n  letter-spacing: 0.1em;\n  font-weight: 100;\n}\n\n.reviewPeople{\n  margin-top: 6%;\n}\n\n.reviewName{\n  line-height: 0.7em;\n  margin-top: 5%;\n}\n\n.reviewName p:nth-child(1){\n  font-size: 16px;\n  color: white;\n}\n\n.reviewName p:nth-child(2){\n  font-size: 14px;\n  color: white;\n}\n\n.faded{\n  opacity: 0.5;\n}\n\n.notFaded{\n  opacity: 1;\n}\n\n.reviewPeople img{\n  width: 57px;\n}\n\n@media (max-width:670px){\n  .reviewName{\n    line-height: 1em;\n  }\n}\n\n@media (max-width:670px){\n  .reviewPeople div:nth-child(3){\n    padding: 0;\n  }\n}\n\n#pricing button:hover {\n  background-color: transparent;\n  border-color: #ffffff;\n  color: #ffffff;\n  background-color: #014FA2;\n  border-radius: 20px;\n  padding-right: 40px;\n  padding-left: 40px;\n  margin-bottom: 10%;\n  padding-top: 3%;\n  margin-top: 10%;\n  padding-bottom: 3%;\n}\n\n.hamburger {\n  height: 30px;\n  margin: 26px;\n  display: -ms-grid;\n  display: grid;\n  -ms-grid-rows: (1fr)[3];\n      grid-template-rows: repeat(3, 1fr);\n  justify-items: center;\n  z-index: 120;\n}\n\n.hamburger div {\n  background-color: rgb(255, 255, 255);\n  position: relative;\n  width: 40px;\n  height: 2px;\n  margin-top: 7px;\n  -webkit-transition: all 0.2s ease-in-out;\n  transition: all 0.2s ease-in-out;\n}\n\n#toggle {\n  display: none;\n}\n\n#toggle:checked + .hamburger .top {\n  -webkit-transform: rotate(-45deg);\n  transform: rotate(-45deg);\n  margin-top: 22.5px;\n}\n\n#toggle:checked + .hamburger .meat {\n  -webkit-transform: rotate(45deg);\n  transform: rotate(45deg);\n  margin-top: -5px;\n}\n\n#toggle:checked + .hamburger .bottom {\n  -webkit-transform: scale(0);\n  transform: scale(0);\n}\n\n#toggle:checked ~ .menu {\n  height: 480px;\n}\n\n/* Menu */\n\n.menu {\n  width: 100%;\n  background-color: #067df4;\n  /*opacity: 0.9;*/\n  margin: 0;\n  display: -ms-grid;\n  display: grid;\n  -ms-grid-rows: 1fr (0.5fr)[4];\n      grid-template-rows: 1fr repeat(4, 0.5fr);\n  grid-row-gap: 25px;\n  padding: 0;\n  list-style: none;\n  clear: both;\n  width: auto;\n  text-align: center;\n  height: 0px;\n  overflow: hidden;\n  -webkit-transition: height 0.4s ease;\n  transition: height 0.4s ease;\n  z-index: 120;\n  -webkit-transition: all 0.3s ease;\n  transition: all 0.3s ease;\n}\n\na:focus, a:hover {\n  text-decoration: none !important;\n}\n\n.menu a{\n  color: #FFFFFF;\n}\n\n.menu a:first-child {\n  margin-top: 58px;\n}\n\n.link {\n  width: 100%;\n  margin: 0;\n  /*padding: 10px 0;*/\n  font: 700 20px \"Oswald\", sans-serif;\n}\n\n/*.link:hover {*/\n\n/*color:#FFFFFF;*/\n\n/*background-color: transparent;*/\n\n/*color: rgb(61, 61, 61);*/\n\n/*-webkit-transition: all 0.3s ease;*/\n\n/*transition: all 0.3s ease;*/\n\n/*}*/\n\n@media (max-width:767px){\n\n  #navbar1{\n    display: none;\n  }\n\n  #navbar{\n    display: block;\n  }\n}\n\na{\n  cursor: pointer;\n}\n\n@media (max-width:400px){\n  .hamburger{\n    margin-right: 35px;\n    margin-top: 20px;\n  }\n  #flight .container{\n    margin-top: -9px;\n    position: relative;\n  }\n}\n\n.navigation{\n  display: none;\n}\n\n@media (max-width:767px) {\n  .pricingCardHolder > div {\n    margin-bottom: 10%;\n  }\n}\n\n@media (max-width:339px){\n  #flight .flightdetails {\n    width: 80.33%\n  }\n  #carriers .carrierdetails{\n    witdh:80.33%;\n  }\n}\n\n@media (min-width:1528px){\n  #flight .container{\n    margin-top: 0px;\n    position: relative;\n  }\n}\n\n@media (min-width:1518px) and (max-width:1523px) {\n  #flight .container{\n    margin-top: -3px;\n    position: relative;\n  }\n}\n\n@media (min-width:1523px) and (max-width:1525px) {\n  #flight .container{\n    margin-top: -3px;\n    position: relative;\n  }\n}\n\n@media (min-width:1526px) and (max-width:1528px) {\n  #flight .container{\n    margin-top: -1px;\n    position: relative;\n  }\n}\n\n@media (min-width:768px) and (max-width:992px) {\n  #footer .txt{\n    margin-left: 30%;\n  }\n  #footer .img{\n    margin-left: 35%;\n    padding-bottom: 10px;\n  }\n  .footerSocialMediaIcons{\n    padding-top: 10px;\n    margin-left: 36%;\n  }\n}\n\n@media (min-width: 768px) {\n  .hamburger{\n    display: none;\n  }\n  .menu a{\n    padding-bottom: 100px;\n  }\n\n}\n\n/*@media (max-width: 768px) {*/\n\n/*#flight .container{*/\n\n/*margin-top: -8.5px;*/\n\n/*z-index: -2;*/\n\n/*position: relative;*/\n\n/*}*/\n\n/*}*/\n\n.loginBtn{\n  padding-right: 40px;\n  padding-left: 40px;\n  background-color: #014FA2;\n  border-radius: 20px;\n  border: none;\n}\n\n.loginBtn:active{\n  color: #fff;\n  background-color: #034fa1;\n  border-color: #034fa1;\n}\n\n.signUp-whole-div{\n  background-color: white;\n  margin-top: 80px;\n}\n\n.signUp-left-div{\n  background-repeat: no-repeat;\n  background-image: url('nature-background-31.85392958f140dc4bc8b9.jpg');\n  opacity: 0.5;\n}\n\n.signUp-left-div-head{\n  font-weight: 300;\n  font-size: 3.5em;\n  margin-top: 80px;\n  color: #ffff;\n  text-align: center;\n}\n\n.sign-cross{\n  margin-top: 20px;\n  margin-right: 21px;\n  color: #929292;\n}\n\n.signUp-left-div-para {\n  font-weight: 300;\n  margin-top: 20px;\n  font-size: 1.2em;\n  color: #ffff;\n}\n\n.signUp-left-div-para2 {\n  font-weight: 300;\n  margin-top: 20px;\n  font-size: 1.2em;\n  color: #ffff;\n}\n\n.logo-img{\n  margin-top: 230px;\n  margin-bottom: 60px;\n}\n\n.form-group1{\n  margin-top: 65px;\n}\n\n.form-group{\n  margin-top: 15px;\n}\n\n.form-group1 , .form-group label{\n  color: #929292;\n  font-weight: 300;\n}\n\n.form-group1 label{\n  color: #929292;\n  font-weight: 300;\n}\n\n.form-control{\n  -webkit-box-shadow: none;\n          box-shadow: none;\n  border: transparent;\n  border-bottom: 1px solid #929292;\n  border-radius: 0;\n}\n\n.signUp-anchor{\n  color: #014FA2;\n}\n\n.checkbox{\n  margin-top: 30px;\n}\n\n.btn-signUp {\n  font-size: 1.2em;\n  margin-top: 50px;\n  background-color: #014FA2;\n  color: #ffffff;\n  width: 180px;\n  height: 50px;\n\n}\n\n.btn-signUp:hover{\n  color: #ffffff;\n  text-decoration: none;\n}\n\n.checkbox label{\n  color: #929292;\n}\n\n.logIn{\n  color: #014FA2;\n}\n\n.login-para{\n  margin-top: 60px;\n  margin-left: 60px;\n  font-size: 1.4em;\n}\n\n@media(max-width: 768px) {\n  .logo-img {\n    margin-top: 5px;\n    margin-bottom: 60px;\n  }\n\n  .btn-signUp {\n    font-size: 1.2em;\n    margin-top: 50px;\n    background-color: #014FA2;\n    color: #ffffff;\n    width: 130px;\n    height: 40px;\n  }\n\n  .signUp-whole-div {\n    background-color: white;\n    margin-top: 80px;\n    padding-bottom: 20px;\n  }\n}\n\n/*******************************\n* MODAL AS LEFT/RIGHT SIDEBAR\n* Add \"left\" or \"right\" in modal parent div, after class=\"modal\".\n* Get free snippets on bootpen.com\n*******************************/\n\n.modal.left .modal-dialog,\n.modal.right .modal-dialog {\n  position: fixed;\n  margin: auto;\n  width: 320px;\n  height: 100%;\n  -webkit-transform: translate3d(0%, 0, 0);\n  transform: translate3d(0%, 0, 0);\n}\n\n.modal.left .modal-content,\n.modal.right .modal-content {\n  height: 100%;\n  overflow-y: auto;\n}\n\n.modal.left .modal-body,\n.modal.right .modal-body {\n  padding: 15px 15px 80px;\n}\n\n/*Left*/\n\n.modal.left.fade .modal-dialog{\n  left: -320px;\n  -webkit-transition: opacity 0.3s linear, left 0.3s ease-out;\n  transition: opacity 0.3s linear, left 0.3s ease-out;\n}\n\n.modal.left.fade.in .modal-dialog{\n  left: 0;\n}\n\n/*Right*/\n\n.modal.right.fade .modal-dialog {\n  right: -320px;\n  -webkit-transition: opacity 0.3s linear, right 0.3s ease-out;\n  transition: opacity 0.3s linear, right 0.3s ease-out;\n}\n\n.modal.right.fade.in .modal-dialog {\n  right: 0;\n}\n\n/* ----- MODAL STYLE ----- */\n\n.modal-content {\n  border-radius: 0;\n  border: none;\n}\n\n.modal-header {\n  border-bottom-color: #EEEEEE;\n  background-color: #FAFAFA;\n}\n\n/* ----- v CAN BE DELETED v ----- */\n\nbody {\n  background-color: #78909C;\n}\n\n.demo {\n  padding-top: 60px;\n  padding-bottom: 110px;\n}\n\n.btn-demo {\n  margin: 15px;\n  padding: 10px 15px;\n  border-radius: 0;\n  font-size: 16px;\n  background-color: #FFFFFF;\n}\n\n.btn-demo:focus {\n  outline: 0;\n}\n\n.demo-footer {\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  padding: 15px;\n  background-color: #212121;\n  text-align: center;\n}\n\n.demo-footer > a {\n  text-decoration: none;\n  font-weight: bold;\n  font-size: 16px;\n  color: #fff;\n}\n\n.sideBarCloseBtn:focus {\n  outline: none !important;\n}\n"

/***/ }),

/***/ "./src/app/cardspage/cardspage.component.html":
/***/ (function(module, exports) {

module.exports = "<!--<script src=\"../../../../../TravelAirmiles/routes/index.js\"></script>-->\n<div class=\"navbar navbar-default navbar-fixed-top\" id=\"navbar\" role=\"navigation\">\n  <div class=\"container\">\n    <a class=\"navbar-brand\" href=\"#\">\n      <div class=\"logo\">\n        <img  src=\"./../../assets/img/logo.png\">\n      </div>\n    </a>\n    <div class=\"navbar-collapse collapse\">\n      <ul class=\"nav navbar-nav navbar-right n\">\n        <li><a (click)=\"gotoCards()\">CARDS</a></li>\n        <li><a (click)=\"gotoBlog()\">BLOG</a></li>\n        <li class=\"l\"><div></div></li>\n        <li>\n\n          <div *ngIf=\"!loggedIn\" style=\"    margin-left: 10%;\n    margin-top: 6%;\" >\n            <button  class=\"loginBtn btn btn-success btn1\" type=\"button\" data-target=\"#signup\" data-toggle=\"modal\">Join</button>\n          </div>\n\n\n          <div *ngIf=\"loggedIn\"  (click)=\"showMenu();\" class=\"row s\" data-toggle=\"dropdown\">\n            <div class=\"col-md-offset-1 col-md-2 i \">\n              <img style=\"height: 30px; width: auto;\" src=\"{{_imageUrl}}\"/>\n            </div>\n\n\n            <div class=\"col-md-offset-1 col-md-8\">\n              <h4>\n                {{_firstName}} {{_lastName}}\n              </h4>\n              <p>\n                {{_username}}\n                <!--<img style=\"float: right; margin-top: -10%;\" src=\"./../../assets/img/expand-arow.png\"/>-->\n              </p>\n\n            </div>\n            <div class=\"col-md-1\">\n\n            </div>\n\n          </div>\n\n\n\n          <ul class=\"dropdown-menu\" id=\"dropdown\" style=\"display: none;\">\n            <li><a style=\"color: #5280C6;\" (click)=\"gotoDashboard();\">Dashboard</a></li>\n            <li><a style=\"color: #5280C6;\" (click)=\"logout();\" >Logout</a></li>\n          </ul>\n        </li>\n      </ul>\n    </div>\n\n\n    <i class=\"fa fa-bars\"  id=\"sideBarToggle\" data-toggle=\"modal\" data-target=\"#myModal2\" style=\"float: right;\n    font-size: 2.5em;\n    color: white;\n    margin-top: 8%;\n     display: none;\n    margin-right: 5%;\" aria-hidden=\"true\"></i>\n\n\n\n    <!-- Modal -->\n    <div class=\"modal right fade\" id=\"myModal2\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel2\">\n      <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\" style=\"    margin-left: 30%;     color: white;\n    font-size: 1.5em;   background-color: #5487c2;\" >\n\n          <div class=\"modal-header\" style=\"    background-color: #5487c2; border-bottom-color: #5487c2; \">\n\n\n\n            <button type=\"button\" class=\"close sideBarCloseBtn\"  data-dismiss=\"modal\" style=\"    color: white;\n    opacity: 1;\n\n    font-size: 1.5em;\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n            <h4 class=\"modal-title\" id=\"myModalLabel2\"></h4>\n          </div>\n\n          <div class=\"modal-body\">\n\n            <div style=\"cursor:pointer; margin-bottom: 10%;\"><span (click)=\"gotoHome()\">Home</span><i class=\"fa fa-home\" style=\"float: right;\" aria-hidden=\"true\"></i></div>\n            <div style=\"cursor:pointer; margin-bottom: 10%;\"><span (click)=\"gotoCards()\">Cards</span><i class=\"fa fa-home\" style=\"float: right;\" aria-hidden=\"true\"></i></div>\n            <div style=\"cursor:pointer;margin-bottom: 10%;\"><span (click)=\"gotoBlog()\">Blog</span><i class=\"fa fa-rss\" style=\"float: right;\" aria-hidden=\"true\"></i></div>\n\n\n            <div *ngIf=\"loggedIn\" style=\"cursor:pointer;margin-bottom: 10%;\" (click)=\"gotoDashboard();\"><span>Dashboard</span><i class=\"fa fa-dashboard\" style=\"float: right;\" aria-hidden=\"true\"></i></div>\n\n            <div *ngIf=\"!loggedIn\" data-target=\"#signup\" data-toggle=\"modal\" style=\"cursor:pointer; margin-top: 65vh;\"><span>Join</span><i class=\"fa fa-sign-in\" style=\"float: right;\" aria-hidden=\"true\"></i></div>\n\n            <div *ngIf=\"loggedIn\" (click)=\"logout();\"  style=\"cursor:pointer; margin-top: 30%;\"><span>Logout</span><i class=\"fa fa-sign-out\" style=\"float: right;\" aria-hidden=\"true\"></i></div>\n\n          </div>\n\n        </div><!-- modal-content -->\n      </div><!-- modal-dialog -->\n    </div><!-- modal -->\n\n\n\n\n\n\n\n\n    <!--<input id=\"toggle\" type=\"checkbox\" />-->\n    <!--<label class=\"hamburger\" for=\"toggle\" style=\"width: 5%; float: right;\">-->\n    <!--<div class=\"top\"></div>-->\n    <!--<div class=\"meat\"></div>-->\n    <!--<div class=\"bottom\"></div>-->\n    <!--</label>-->\n\n    <!--<nav class=\"menu\">-->\n    <!--<a class=\"link\">About</a>-->\n    <!--<a class=\"link\" >Blog</a>-->\n    <!--<a class=\"link\" >Profile</a>-->\n    <!--<a class=\"link\" >Dashboard</a>-->\n    <!--<a class=\"link\" >Logout</a>-->\n    <!--<a></a>-->\n    <!--</nav>-->\n  </div>\n</div>\n\n\n<!--HOME-->\n\n<section id=\"home\">\n\n  <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-md-5 col-sm-7\">\n        <h2>Discover the potential\n          of your airmiles</h2>\n        <p>Get notified instantly on airmiles for the best\n          deals on your selected destinations.</p>\n      </div>\n    </div>\n    <div class=\"row r\">\n      <div class=\"col-md-2 col-sm-3 col-xs-4\">\n        <button type=\"button\" class=\"btn btn-success btn1\">Get Started</button>\n      </div>\n      <div class=\"col-md-2 col-sm-3 col-xs-3\">\n        <button data-toggle=\"modal\" data-target=\"#myModal\"  type=\"button\" class=\"btn btn-success btn2\"><i class=\"fa fa-play-circle-o\" aria-hidden=\"true\"></i>Watch Video</button>\n      </div>\n\n      <div id=\"myModal\" class=\"modal fade\" role=\"dialog\">\n        <div class=\"modal-dialog\" style=\"\n      margin-top: 5%;\n    width: 90%;\">\n\n          <!-- Modal content-->\n          <div class=\"modal-content\" style=\"    height: 85vh;\n    margin-left: 2%;\n    margin-right: 2%;\">\n            <iframe style=\"width: 100%;\n    height: 100%;\" src=\"https://www.youtube.com/embed/2gBxS_8_Zkg\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen></iframe>\n          </div>\n\n        </div>\n      </div>\n\n    </div>\n  </div>\n</section>\n\n<!--HOME-ENDS-->\n\n\n<section id=\"head\">\n\n  <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-md-12 col-sm-12\">\n        <h1 class=\"heading-credit-card\">\n          CREDIT CARD GENIE\n        </h1>\n      </div>\n    </div>\n  </div>\n</section>\n\n<section id=\"card\">\n  <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-md-12 col-sm-12\">\n        <h1 class=\"card-heading\">I Want..</h1>\n      </div>\n    </div>\n    <div class=\"row\">\n\n      <div class=\"col-md-3  col-sm-3 col-sm-offset-1  col-xs-8 col-xs-offset-2 shadow\">\n        <div class=\"main\">\n          <h2 class=\"price-card-head\">YELLOW CARD</h2>\n          <div class=\"line\">\n\n          </div>\n          <P class=\"price-card-para\">Lorem ipsum dolor sit amet, <br>\n            consectetur adipiscing elit.</P>\n        </div>\n\n        <div class=\"img-div\">\n          <img class=\"img-responsive img-card\" src=\"./../../assets/img/background.png\">\n        </div>\n      </div>\n\n      <div class=\"col-md-3 col-md-offset-1 col-sm-offset-1  col-sm-3 col-xs-8 col-xs-offset-2 shadow\">\n        <div class=\"main\">\n          <h2 class=\"price-card-head\">YELLOW CARD</h2>\n          <div class=\"line\">\n\n          </div>\n          <P class=\"price-card-para\">Lorem ipsum dolor sit amet, <br>\n            consectetur adipiscing elit.</P>\n        </div>\n\n        <div class=\"img-div\">\n          <img class=\"img-responsive img-card\" src=\"./../../assets/img/background.png\">\n        </div>\n      </div>\n\n\n      <div class=\"col-md-3 col-md-offset-1 col-sm-offset-1  col-sm-3 col-xs-8 col-xs-offset-2 shadow\">\n        <div class=\"main\">\n          <h2 class=\"price-card-head\">YELLOW CARD</h2>\n          <div class=\"line\">\n\n          </div>\n          <P class=\"price-card-para\">Lorem ipsum dolor sit amet, <br>\n            consectetur adipiscing elit.</P>\n        </div>\n\n        <div class=\"img-div\">\n          <img class=\"img-responsive img-card\" src=\"./../../assets/img/background.png\">\n        </div>\n      </div>\n\n\n    </div>\n\n    <div class=\"row  card-row2\">\n\n      <div class=\"col-md-3  col-sm-3 col-sm-offset-1  col-xs-8 col-xs-offset-2 shadow\">\n        <div class=\"main\">\n          <h2 class=\"price-card-head\">YELLOW CARD</h2>\n          <div class=\"line\">\n\n          </div>\n          <P class=\"price-card-para\">Lorem ipsum dolor sit amet, <br>\n            consectetur adipiscing elit.</P>\n        </div>\n\n        <div class=\"img-div\">\n          <img class=\"img-responsive img-card\" src=\"./../../assets/img/background.png\">\n        </div>\n      </div>\n\n      <div class=\"col-md-3 col-md-offset-1 col-sm-3  col-sm-offset-1 col-xs-offset-2 col-xs-8 shadow\">\n        <div class=\"main\">\n          <h2 class=\"price-card-head\">YELLOW CARD</h2>\n          <div class=\"line\">\n\n          </div>\n          <P class=\"price-card-para\">Lorem ipsum dolor sit amet, <br>\n            consectetur adipiscing elit.</P>\n        </div>\n\n        <div class=\"img-div\">\n          <img class=\"img-responsive img-card\" src=\"./../../assets/img/background.png\">\n        </div>\n      </div>\n\n\n      <div class=\"col-md-3 col-md-offset-1 col-sm-3 col-sm-offset-1 col-xs-offset-2   col-xs-8 shadow\">\n        <div class=\"main\">\n          <h2 class=\"price-card-head\">YELLOW CARD</h2>\n          <div class=\"line\">\n\n          </div>\n          <P class=\"price-card-para\">Lorem ipsum dolor sit amet, <br>\n            consectetur adipiscing elit.</P>\n        </div>\n\n        <div class=\"img-div\">\n          <img class=\"img-responsive img-card\" src=\"./../../assets/img/background.png\">\n        </div>\n      </div>\n\n\n    </div>\n\n  </div>\n</section>\n\n<section  id=\"footer\">\n  <div  class=\"container\">\n    <div  class=\"row one\">\n      <div  class=\"col-md-2 col-sm-2 col-xs-12 img\">\n        <img  src=\"./../../assets/img/logo.png\">\n      </div>\n      <div  class=\"col-md-3 col-md-offset-2 col-sm-6 col-sm-offset-1 col-xs-12 txt\">\n        <h5 >\n          Femme 2018 All Rights Reserved.\n        </h5>\n      </div>\n      <div  class=\"footerSocialMediaIcons col-md-offset-2 col-md-3 col-sm-3 col-xs-5 col-xs-offset-3\">\n        <div  class=\"col-md-3 col-sm-3 col-xs-3\">\n          <i  class=\"fa fa-facebook fa-2x\"></i>\n        </div>\n        <div  class=\"col-md-3 col-sm-3 col-xs-3\">\n          <i  class=\"fa fa-twitter fa-2x\"></i>\n        </div>\n        <div  class=\"col-md-3 col-sm-3 col-xs-3\">\n          <i  class=\"fa fa-instagram fa-2x\"></i>\n        </div>\n        <div  class=\"col-md-3 col-sm-3 col-xs-3\">\n          <i  class=\"fa fa-pinterest fa-2x\"></i>\n        </div>\n      </div>\n    </div>\n  </div>\n</section>\n\n\n\n\n<div _ngcontent-c1=\"\" class=\"modal fade\" id=\"signup\" role=\"dialog\" >\n  <div _ngcontent-c1=\"\" class=\"modal-dialog signupModalDialog\" style=\"width: 70%;\">\n\n\n\n\n    <div class=\"row signUp-whole-div\">\n      <div class=\"col-md-4 col-xs-12 col-sm-4 signUp-left-div\">\n\n        <div class=\"col-md-8 col-xs-8 col-sm-12 col-md-offset-1\">\n          <p class=\"signUp-left-div-head\">\n            Sign up\n          </p>\n        </div>\n\n        <div class=\"col-md-8 col-xs-8 col-sm-12 col-md-offset-2\">\n          <p class=\"signUp-left-div-para\">\n            it is much better when you have account\n          </p>\n        </div>\n        <div class=\"col-md-8 col-xs-8 col-sm-12 col-md-offset-2\">\n          <p class=\"signUp-left-div-para2\">\n            Get Yourself one\n          </p>\n        </div>\n\n        <div class=\"col-md-8 col-xs-8 col-sm-8 col-md-offset-2 logo-img\">\n          <img class=\"\" src=\"./../../assets/img/logo.png\" alt=\"\">\n        </div>\n\n      </div>\n\n\n      <div class=\"col-md-8 col-xs-12 col-sm-8\">\n        <div class=\"close\" data-dismiss=\"modal\" class=\"row\" align=\"right\" id=\"signupModalCloseBtn\" style=\"cursor: pointer;\">\n          <i class=\"fa fa-times fa-2x sign-cross\"></i>\n\n        </div>\n        <div class=\"col-md-8 col-xs-12 col-sm-12 col-md-offset-2\">\n          <form>\n            <div class=\"form-group\">\n              <label for=\"email\">First Name:</label>\n              <input type=\"email\" class=\"form-control\" [(ngModel)] ='firstName' id=\"first\" name=\"first\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"email\">Last Name:</label>\n              <input type=\"email\" class=\"form-control\" [(ngModel)] ='lastName' id=\"last\" name=\"last\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"email\">User Name:</label>\n              <input type=\"email\" class=\"form-control\" [(ngModel)] ='username' id=\"user\" name=\"name\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"email\">Email:</label>\n              <input type=\"email\" class=\"form-control\" [(ngModel)] ='email' id=\"email\" name=\"email\">\n            </div>\n            <div class=\"form-group\">\n              <label >Password:</label>\n              <input type=\"password\" class=\"form-control\"  [(ngModel)] ='password' id=\"Password\" name=\"pwd\">\n            </div>\n            <div  class=\"form-group\" style=\"margin-left: 0px;\">\n              <label  for=\"exampleFormControlFile1\">Profile Picture</label>\n              <input class=\"form-control-file\" id=\"exampleFormControlFile1\"  (change)=\"uploadFile($event)\" style=\"    margin-left: 17%;\" type=\"file\">\n            </div>\n            <!--<div class=\"checkbox\">-->\n            <!--<label><input type=\"checkbox\" name=\"remember\">by signing up i agree to <a class=\"signUp-anchor\" href=\"#\">terms and condition</a>  </label>-->\n            <!--</div>-->\n\n            <div class=\"row\">\n              <div class=\"col-md-4 col-xs-6\"> <button type=\"submit\" (click)=\"signup()\"  class=\"btn btn-signUp\">Submit</button></div>\n              <div class=\"col-md-4 col-xs-6\"> <p class=\"login-para\"> or   <a class=\"logIn\" id=\"openLogin\" data-target=\"#login\" data-toggle=\"modal\"> Login</a></p></div>\n            </div>\n          </form>\n\n        </div>\n\n      </div>\n    </div>\n\n\n\n\n\n\n\n    <!--<div _ngcontent-c1=\"\" class=\"modal-content signupModalContent\" style=\"height: 685px;  \">-->\n    <!--<div _ngcontent-c1=\"\" class=\"modal-header\">-->\n    <!--<button _ngcontent-c1=\"\" class=\"close\" data-dismiss=\"modal\" id=\"signupModalCloseBtn\" type=\"button\">×</button>-->\n    <!--<h4 _ngcontent-c1=\"\" class=\"modal-title\" style=\"text-align: center;\">Signup</h4>-->\n    <!--</div>-->\n    <!--<div _ngcontent-c1=\"\" class=\"modal-body\">-->\n    <!--<form _ngcontent-c1=\"\" class=\"form-horizontal ng-untouched ng-pristine ng-invalid\" id=\"2\" method=\"post\" novalidate=\"\" role=\"form\" style=\"\">-->\n    <!--<div _ngcontent-c1=\"\" class=\"row\">-->\n    <!--<div _ngcontent-c1=\"\" class=\"col-md-7 col-sm-7\" style=\"border-right: 1px solid #c4c4c4;padding-right: 5%; padding-left: 5%;\">-->\n    <!--<label _ngcontent-c1=\"\">First Name</label>-->\n    <!--<div _ngcontent-c1=\"\" class=\"input-group col-md-offset-4\" style=\"margin-bottom: 25px; margin-left: 0;     width: 100%;\">-->\n    <!--<input _ngcontent-c1=\"\" class=\"form-control popupInput ng-untouched ng-pristine ng-invalid\" [(ngModel)] ='firstName' name=\"firstName\" required=\"\" style=\"   \" type=\"firstName\" value=\"\" ng-reflect-required=\"\" ng-reflect-name=\"firstName\" ng-reflect-model=\"\">-->\n    <!--</div>-->\n    <!--<label _ngcontent-c1=\"\">Last Name</label>-->\n    <!--<div _ngcontent-c1=\"\" class=\"input-group col-md-offset-4\" style=\"margin-bottom: 25px; margin-left: 0;     width: 100%;\">-->\n    <!--<input _ngcontent-c1=\"\" class=\"form-control popupInput ng-untouched ng-pristine ng-invalid\"  [(ngModel)] ='lastName' name=\"lastName\" required=\"\" style=\"\" type=\"lastName\" value=\"\" ng-reflect-required=\"\" ng-reflect-name=\"lastName\" ng-reflect-model=\"\">-->\n    <!--</div>-->\n    <!--<label _ngcontent-c1=\"\">Username</label>-->\n    <!--<div _ngcontent-c1=\"\" class=\"input-group col-md-offset-4\" style=\"margin-bottom: 25px; margin-left: 0;     width: 100%;\">-->\n    <!--<input _ngcontent-c1=\"\" class=\"form-control popupInput ng-untouched ng-pristine ng-invalid\"  [(ngModel)] ='username' name=\"signupUserPassword\" required=\"\" type=\"text\" value=\"\" ng-reflect-required=\"\" ng-reflect-name=\"signupUserPassword\" ng-reflect-model=\"\">-->\n    <!--</div>-->\n\n    <!--<label _ngcontent-c1=\"\">Email Name</label>-->\n    <!--<div _ngcontent-c1=\"\" class=\"input-group col-md-offset-4\" style=\"margin-bottom: 25px; margin-left: 0;     width: 100%;\">-->\n    <!--<input _ngcontent-c1=\"\" class=\"form-control popupInput ng-untouched ng-pristine ng-invalid\"  [(ngModel)] ='email' name=\"signupUserEmail\" required=\"\" style=\"\" type=\"email\" value=\"\" ng-reflect-required=\"\" ng-reflect-name=\"signupUserEmail\" ng-reflect-model=\"\">-->\n    <!--</div>-->\n    <!--<label _ngcontent-c1=\"\">Password</label>-->\n    <!--<div _ngcontent-c1=\"\" class=\"input-group col-md-offset-4\" style=\"margin-bottom: 25px; margin-left: 0;     width: 100%;\">-->\n    <!--<input _ngcontent-c1=\"\" class=\"form-control popupInput ng-untouched ng-pristine ng-invalid\"  [(ngModel)] ='password' name=\"signupUserPassword\" required=\"\" type=\"password\" value=\"\" ng-reflect-required=\"\" ng-reflect-name=\"signupUserPassword\" ng-reflect-model=\"\">-->\n    <!--</div>-->\n\n\n    <!--<div _ngcontent-c1=\"\" class=\"input-group col-md-offset-4 popupFileUpload \" style=\"  margin-left: 0;  margin-bottom: 5%;     width: 100%;\">-->\n    <!--<div _ngcontent-c1=\"\" class=\"form-group\" style=\"margin-left: 0px;\">-->\n    <!--<label _ngcontent-c1=\"\" for=\"exampleFormControlFile1\">Profile Picture</label>-->\n    <!--<input _ngcontent-c1=\"\" class=\"form-control-file\" id=\"exampleFormControlFile1\"  (change)=\"uploadFile($event)\" style=\"    margin-left: 17%;\" type=\"file\">-->\n    <!--</div>-->\n    <!--</div>-->\n    <!--<div _ngcontent-c1=\"\" class=\"form-group\" style=\"margin-top: 10px; margin-left: 0px; margin-bottom: 0;\">-->\n    <!--<div _ngcontent-c1=\"\" class=\"col-sm-12 controls\" style=\"text-align: center;\"><button _ngcontent-c1=\"\" (click)=\"signup()\" class=\"btn btn-primary\" style=\"margin-left: 10px; margin-bottom: 10px; margin-top: 10px; text-align: center; width: 200px; background-color: rgb(0, 151, 167); border-radius: 1px;\" type=\"button\">Submit</button>-->\n    <!--</div>-->\n    <!--</div>-->\n    <!--</div>-->\n    <!--<div _ngcontent-c1=\"\" class=\"col-md-5 col-sm-5\" style=\"text-align: center;\">-->\n    <!--<p _ngcontent-c1=\"\">or signup using any of the social networks</p>-->\n    <!--<button _ngcontent-c1=\"\" classnamename=\"btn btn-primary\" style=\"color: rgb(255, 255, 255); text-align: center; height: 35px; margin-right: 30px; margin-bottom: 20px; width: 200px; margin-left: 40px; background-color: rgb(48, 63, 159);\" type=\"button\"><i _ngcontent-c1=\"\" aria-hidden=\"true\" class=\"fa fa-facebook \" style=\"margin-right: 10px;\"></i>Login With Facebook</button>-->\n    <!--</div>-->\n\n    <!--<div _ngcontent-c1=\"\" class=\"col-md-5 col-sm-5\" style=\"text-align: center;\">-->\n    <!--<p _ngcontent-c1=\"\">or login with your email</p>-->\n    <!--<button _ngcontent-c1=\"\" id=\"openLogin\" data-target=\"#login\" data-toggle=\"modal\" classnamename=\"btn btn-primary\" style=\"color: rgb(255, 255, 255); text-align: center; height: 35px; margin-right: 30px; margin-bottom: 20px; width: 200px; margin-left: 40px;     background-color: rgb(0, 151, 167);\" type=\"button\"><i _ngcontent-c1=\"\" aria-hidden=\"true\" class=\"fa fa-envelope-o \" style=\"margin-right: 10px;\"></i>Login With Email</button>-->\n    <!--</div>-->\n\n    <!--</div>-->\n    <!--<div _ngcontent-c1=\"\" class=\"row\">-->\n    <!--<div _ngcontent-c1=\"\" class=\"col-md-12 col-sm-12\" style=\"border-top: 1px solid #c4c4c4; text-align: center; margin-top: 15px;\">-->\n    <!--<p _ngcontent-c1=\"\" style=\"margin-top: 10px;     color: #a09c9c;\">By regestering I conform that I have read and agree with <a _ngcontent-c1=\"\" data-target=\"#privicyPolicy\" data-toggle=\"modal\"><u _ngcontent-c1=\"\">Privacy Policy</u></a>.</p>-->\n    <!--</div>-->\n    <!--</div>-->\n    <!--</form>-->\n\n\n\n\n\n\n\n\n\n    <!--</div>-->\n    <!--</div>-->\n  </div>\n</div>\n\n\n\n\n<div _ngcontent-c1=\"\" class=\"modal fade\" id=\"login\" role=\"dialog\" >\n  <div _ngcontent-c1=\"\" class=\"modal-dialog signinModalDialog\" style=\"width: 70%;\">\n\n\n    <div class=\"row signUp-whole-div\">\n      <div class=\"col-md-4 col-xs-12 col-sm-4 signUp-left-div\">\n\n        <div class=\"col-md-8 col-xs-8 col-sm-12 col-md-offset-1\">\n          <p class=\"signUp-left-div-head\">\n            Login\n          </p>\n        </div>\n\n        <div class=\"col-md-8 col-xs-8 col-sm-12 col-md-offset-2\">\n          <p class=\"signUp-left-div-para\">\n            it is much better when you have account\n          </p>\n        </div>\n        <div class=\"col-md-8 col-xs-8 col-sm-12 col-md-offset-2\">\n          <p class=\"signUp-left-div-para2\">\n            Get Yourself one\n          </p>\n        </div>\n\n        <div class=\"col-md-8 col-xs-8 col-sm-8 col-md-offset-2 logo-img\">\n          <img class=\"\" src=\"./../../assets/img/logo.png\" alt=\"\">\n        </div>\n\n      </div>\n\n\n      <div class=\"col-md-8 col-xs-12 col-sm-8\">\n        <div class=\"close\" data-dismiss=\"modal\" class=\"row\" align=\"right\" id=\"loginModalCloseBtn\" style=\"cursor: pointer;\">\n          <i class=\"fa fa-times fa-2x sign-cross\"></i>\n\n        </div>\n        <div class=\"col-md-8 col-xs-12 col-sm-12 col-md-offset-2\">\n          <form>\n            <div class=\"form-group\">\n              <label for=\"email\">Email:</label>\n              <input type=\"email\" class=\"form-control\" [(ngModel)]=\"loginEmail\" name=\"loginUserEmail\">\n            </div>\n            <div class=\"form-group\">\n              <label >Password:</label>\n              <input type=\"password\" class=\"form-control\"   [(ngModel)]=\"loginPassword\" name=\"loginUserPassword\">\n            </div>\n            <!--<div class=\"checkbox\">-->\n            <!--<label><input type=\"checkbox\" name=\"remember\">by signing up i agree to <a class=\"signUp-anchor\" href=\"#\">terms and condition</a>  </label>-->\n            <!--</div>-->\n            <div class=\"row\">\n              <div class=\"col-md-4 col-xs-6\"> <button type=\"button\" (click)=\"login()\"  class=\"btn btn-signUp\">Login</button></div>\n              <!--<div class=\"col-md-4 col-xs-6\"> <p class=\"login-para\"> or   <a class=\"logIn\" id=\"openLogin\" data-target=\"#login\" data-toggle=\"modal\"> Login</a></p></div>-->\n            </div>\n          </form>\n\n        </div>\n\n      </div>\n    </div>\n\n    <!--<div _ngcontent-c1=\"\" class=\"modal-content signinModalContent\" style=\"    height: 310px;  \">-->\n    <!--<div _ngcontent-c1=\"\" class=\"modal-header\">-->\n    <!--<button _ngcontent-c1=\"\" class=\"close\" data-dismiss=\"modal\" id=\"loginModalCloseBtn\" type=\"button\">×</button>-->\n    <!--<h4 _ngcontent-c1=\"\" class=\"modal-title\" style=\"text-align: center;\">Login</h4>-->\n    <!--</div>-->\n    <!--<div _ngcontent-c1=\"\" class=\"modal-body\">-->\n    <!--<form _ngcontent-c1=\"\" class=\"form-horizontal ng-untouched ng-pristine ng-invalid\" id=\"loginform\" method=\"post\" novalidate=\"\" role=\"form\" style=\"text-align: center;\">-->\n    <!--<div _ngcontent-c1=\"\" class=\"col-md-6 col-sm-6 loginXsNoBorder\" style=\"border-right: 1px solid #c4c4c4;-->\n    <!--padding-right: 5%;\">-->\n    <!--<label _ngcontent-c1=\"\" style=\"float: left;\">Email Name</label>-->\n    <!--<div _ngcontent-c1=\"\" class=\"input-group col-md-offset-4\" style=\"margin-bottom: 25px; margin-left: 0;     width: 100%;\">-->\n    <!--<input _ngcontent-c1=\"\" class=\"form-control popupInput ng-untouched ng-pristine ng-invalid\" [(ngModel)]=\"loginEmail\" name=\"loginUserEmail\" required=\"\" style=\"\" type=\"email\" value=\"\" ng-reflect-required=\"\" ng-reflect-name=\"loginUserEmail\" ng-reflect-model=\"\">-->\n    <!--</div>-->\n    <!--<label _ngcontent-c1=\"\" style=\"float: left;\">Password</label>-->\n    <!--<div _ngcontent-c1=\"\" class=\"input-group col-md-offset-4\" style=\"margin-bottom: 25px; margin-left: 0;     width: 100%;\">-->\n    <!--<input _ngcontent-c1=\"\" class=\"form-control popupInput ng-untouched ng-pristine ng-invalid\" [(ngModel)]=\"loginPassword\" name=\"loginUserPassword\" required=\"\" type=\"password\" value=\"\" ng-reflect-required=\"\" ng-reflect-name=\"loginUserPassword\" ng-reflect-model=\"\">-->\n    <!--</div>-->\n    <!--<div _ngcontent-c1=\"\" class=\"form-group\" style=\"margin-top: 10px; margin-left: 0px; margin-bottom: 0;\">-->\n    <!--<div _ngcontent-c1=\"\" class=\"col-sm-12 controls\" style=\"text-align: center;\"><button (click)=\"login()\" _ngcontent-c1=\"\" class=\"btn btn-primary\" style=\"margin-left: 10px; margin-bottom: 10px; margin-top: 10px; text-align: center; width: 200px; background-color: rgb(0, 151, 167); border-radius: 1px;\" type=\"button\">Submit</button>-->\n    <!--</div>-->\n    <!--</div>-->\n    <!--</div>-->\n    <!--<div _ngcontent-c1=\"\" class=\"col-md-6 col-sm-6\" style=\"text-align: center;\">-->\n    <!--<p _ngcontent-c1=\"\">or signin using any of the social networks</p>-->\n    <!--<button _ngcontent-c1=\"\" classnamename=\"btn btn-primary\" style=\"color: rgb(255, 255, 255); text-align: center; height: 35px; margin-right: 30px; margin-bottom: 20px; width: 200px; margin-left: 40px; background-color: rgb(48, 63, 159);\" type=\"button\">-->\n    <!--<i _ngcontent-c1=\"\" aria-hidden=\"true\" class=\"fa fa-facebook \" style=\"margin-right: 10px;\"></i>Login With Facebook</button>-->\n    <!--</div>-->\n    <!--</form>-->\n    <!--</div>-->\n\n\n\n    <!--</div>-->\n  </div>\n</div>\n"

/***/ }),

/***/ "./src/app/cardspage/cardspage.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CardspageComponent = /** @class */ (function () {
    function CardspageComponent(http, toastr, vcr, router) {
        this.http = http;
        this.toastr = toastr;
        this.router = router;
        this.firstName = '';
    ...
    CardspageComponent.prototype.signup = function () {
        var _this = this;
        this.regexp = new RegExp(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/);
        if (this.firstName.length == 0) {
            this.toastr.error('First Name Required!', 'Field Required!');
    ...
    CardspageComponent.prototype.login = function () {
        var _this = this;
        this.regexp = new RegExp(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/);
        if (this.loginEmail.length == 0) {
            this.toastr.error('Email Required!', 'Field Required!');
    ...
    CardspageComponent.prototype.showMenu = function () {
        if (__WEBPACK_IMPORTED_MODULE_4_jquery__('#dropdown').css('display') == 'none') {
            __WEBPACK_IMPORTED_MODULE_4_jquery__('#dropdown').css('display', 'block');
        }
        else {
    ...
    CardspageComponent.prototype.getBase64 = function (file) {
        var _this = this;
        var reader = new FileReader();
        reader.readAsDataURL(file);
        reader.onload = function () {
    ...
    CardspageComponent.prototype.uploadFile = function (event) {
        console.log(event.target.files[0]);
        if (typeof event.srcElement == 'undefined') {
            var fileSize = event.target.files[0].size;
            var fileData = event.target.files[0];
    ...
    CardspageComponent.prototype.logout = function () {
        localStorage.removeItem('id');
        this.toastr.success("Logout Sucessful!", 'Success!');
        setTimeout(function () { window.location.reload(); }, 1000);
    };
    CardspageComponent.prototype.gotoDashboard = function () {
        this.router.navigate(['dashboard']);
    };
    CardspageComponent.prototype.gotoHome = function () {
        this.router.navigate(['']);
    };
    CardspageComponent.prototype.gotoCards = function () {
        this.router.navigate(['cards']);
    };
    CardspageComponent.prototype.gotoBlog = function () {
        this.router.navigate(['blog']);
    };
    CardspageComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-cardspage',
            template: __webpack_require__("./src/app/cardspage/cardspage.component.html"),
            styles: [__webpack_require__("./src/app/cardspage/cardspage.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_2_ng2_toastr__["ToastsManager"], __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewContainerRef"], __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */]])
    ], CardspageComponent);
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.gotoCards = function () {
        this.router.navigate(['cards']);
    };
    DashboardComponent.prototype.gotoBlog = function () {
        this.router.navigate(['blog']);
    };
